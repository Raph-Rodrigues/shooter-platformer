...
SRCS = src/main.c src/glad.c src/engine/global.c src/engine/render/render.c src/engine/render/render_init.c src/engine/render/render_util.c src/engine/io/io.c
